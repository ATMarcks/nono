...
let MiddleclickDirective = class MiddleclickDirective {
    constructor() {
...
let GameService = class GameService {
    ...
    newGame(cols, rows) {
        const newGame = this.createNewGame(cols, rows);
